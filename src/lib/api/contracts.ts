...
export type AvailabilityQuote={availabilityToken:string;priceQuoteId:string;currency:string;baseAmount:MoneyAmount;feesAmount:MoneyAmount;couponAmount:MoneyAmount;pointsBenefitAmount:MoneyAmount;customerTotal:MoneyAmount;expiresAt:string};
